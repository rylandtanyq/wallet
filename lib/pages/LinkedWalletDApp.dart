      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text("暂未连接任何DApp", style: AppTextStyles.size19.copyWith(color: Theme.of(context).colorScheme.onBackground)),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 9.w),
                  Text("扫描连接", style: AppTextStyles.labelMedium.copyWith(color: Theme.of(context).colorScheme.onPrimary)),
                ],
              ),
            ),
            Spacer(flex: 3),
