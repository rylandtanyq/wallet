...
class _SituationToTrendPageState extends State<SituationToTrendPage>
    with BasePage<SituationToTrendPage>, AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return EasyRefresh(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Image.asset('assets/images/bg_hangqingqushi.jpg')
            ],
          ),
        ),
    );
