...
class _DiscoveryHotListPageState extends State<DiscoveryHotListPage>
    with BasePage<DiscoveryHotListPage>, AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return EasyRefresh(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Image.asset('assets/images/bg_hotlist.jpg')
            ],
          ),
        ),
    );
