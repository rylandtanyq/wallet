...
class _TradeToContractPageState extends State<TradeToContractPage>
    with BasePage<TradeToContractPage>, AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return EasyRefresh(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Image.asset('assets/images/bg_jiaoyiheyue.jpg')
            ],
          ),
        ),
    );
