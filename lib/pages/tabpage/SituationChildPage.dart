...
class _SituationChildPageState extends State<SituationChildPage>
    with BasePage<SituationChildPage>, SingleTickerProviderStateMixin {
                      ...
                      Expanded(child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8.w),
                            Text('搜索您感兴趣的币',style: TextStyle(fontSize: 14.sp, color: Colors.grey),),
                      ...
                      child: Row(
                        ...
                        children: List.generate(pageCount, (index) {
                          return GestureDetector(
                            onTap: () {
                              _indicatorPageController.animateToPage(
                                index,
          ...
          children: [
            ...
            ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: _chainSubIndex == 0 ? AppColors.color_2B6D16 : Colors.white,
                  side: BorderSide(
                    color: _chainSubIndex == 0 ? AppColors.color_2B6D16 : AppColors.color_E2E2E2, // 边框颜色
                    width: 1.0,        // 边框宽度
                  ),
                ...
                child: Text(
                  '全链',
                  style: TextStyle(
                    color:  _chainSubIndex == 0 ? Colors.white : AppColors.color_909090,
                    fontSize: 13.sp,
                  ),
                )
            ),
            ...
            ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: _chainSubIndex == 1 ? AppColors.color_2B6D16 : Colors.white,
                  side: BorderSide(
                    color: _chainSubIndex == 1 ? AppColors.color_2B6D16 : AppColors.color_E2E2E2, // 边框颜色
                    width: 1.0,        // 边框宽度
                  ),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(13.5.r), // 圆角21.5dp
                ...
                child: Text(
                  '合约',
                  style: TextStyle(
                    color:  _chainSubIndex == 1 ? Colors.white : AppColors.color_909090,
                    fontSize: 13.sp,
                  ),
                )
            )
      ...
      children: [
        ...
        Row(
          children: [
            ...
            ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: _collectSubIndex == 0 ? AppColors.color_F7F8F9 : Colors.white,
                  shape: RoundedRectangleBorder(
                ...
                child: Text(
                  '我的收藏',
                  style: TextStyle(
                    color:  _collectSubIndex == 0 ? Colors.black : AppColors.color_909090,
                    fontSize: 11.sp,
                  ),
                )
            ),
            ...
            ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: _collectSubIndex == 1 ? AppColors.color_F7F8F9 : Colors.white,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(11.5.r), // 圆角21.5dp
                  ),
                  padding: EdgeInsets.symmetric(
                ...
                child: Text(
                  '浏览记录',
                  style: TextStyle(
                    color:  _collectSubIndex == 1 ? Colors.black : AppColors.color_909090,
                    fontSize: 11.sp,
                  ),
                )
            ),
      ...
      slivers: [
        ...
        SliverGrid(
          ...
          delegate: SliverChildBuilderDelegate(
              ...
              child: Row(
                children: [
                  Image.asset('assets/images/ic_home_bit_coin.png',
                    width: 35,
                    height: 35,
                  ),
                  const SizedBox(width: 10),
                  const Expanded(child: Text('BTC')),
                  Image.asset('assets/images/ic_arrows_right.png',
                    width: 13,
                    height: 8,
                  ),
                ],
      ...
      itemBuilder: (_, index) => Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 10.w),
            Expanded(
              child: Text('BTC', style: TextStyle(fontSize: 15.sp)),
            ),
            Image.asset('assets/images/ic_arrows_right.png',
              width: 13.w,
              height: 8.w,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(child: Text('BTC',style: TextStyle(fontSize: 15.sp),)),
              Image.asset('assets/images/ic_home_bit_coin.png', width: 18.w,height: 18.w,),
            ],
          ),
          SizedBox(height: 16.h,),
          Text('\$97,890.90',style: TextStyle(fontSize: 15.sp,fontWeight: FontWeight.bold),),
          SizedBox(height: 3.h,),
          Text('+0.32%',style: TextStyle(fontSize: 13.sp,fontWeight: FontWeight.bold,color: AppColors.color_286713),),
        ],
      ),
    );
  }
