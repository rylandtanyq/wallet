...
class _TradeChildPageState extends State<TradeChildPage>
    with BasePage<TradeChildPage>, AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return EasyRefresh(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Image.asset('assets/images/bg_jiaoyi.jpg')
            ],
          ),
        ),
    );
