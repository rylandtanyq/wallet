        ...
        title: Padding(padding: EdgeInsets.all(10),
          child: Row(
            children: [
              ...
              Expanded(child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 8.w),
                    Text('BTC/USDT',style: TextStyle(fontSize: 14.sp, color: Colors.grey),),
                  ],
                  ),
                )
              )
              ,
              SizedBox(width: 22.w),
              Image.asset('assets/images/ic_home_link.png',width: 16.w,height: 16.w),
              SizedBox(width: 22.w),
              Image.asset('assets/images/ic_home_scan.png',width: 16.w,height: 16.w),
              SizedBox(width: 22.w),
              Image.asset('assets/images/ic_home_message.png',width: 16.w,height: 16.w),
            ],
          ),
        ),
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text('我的钱包',style: TextStyle(fontSize: 15.sp,fontWeight: FontWeight.bold),),
                        SizedBox(width: 8.w,),
                        Image.asset('assets/images/ic_arrows_down.png',width: 10.w,height: 6.w),
                      ],),
                  ),
                  Text('¥35.00',style: TextStyle(fontSize: 35.sp,fontWeight: FontWeight.bold),),
                  SizedBox(width: 10.h,),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    mainAxisSize: MainAxisSize.min,
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              Text('立即备份',style: TextStyle(fontSize: 12.sp, color: Colors.black),),
                              SizedBox(width: 5.w),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(child: Text('赚币中心',style: TextStyle(fontSize: 19.sp,fontWeight: FontWeight.bold,color: Colors.black),)),
                        Text('共3个活动',style: TextStyle(fontSize: 13.sp,color: Colors.grey)),
                        SizedBox(width: 5.w,),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('全链榜单',style: TextStyle(fontSize: 19.sp,fontWeight: FontWeight.bold,color: Colors.black),)
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('热搜代币',style: TextStyle(fontSize: 19.sp,fontWeight: FontWeight.bold,color: Colors.black),)
                      ],
                    ),
                  ),
                  SizedBox(
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(child: Text('合约交易',style: TextStyle(fontSize: 19.sp,fontWeight: FontWeight.bold,color: Colors.black),)),
                        Image.asset('assets/images/ic_arrows_right.png',width: 7,height: 12,),
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Expanded(child: Text('使用指南',style: TextStyle(fontSize: 19.sp,fontWeight: FontWeight.bold,color: Colors.black),)),
                        Image.asset('assets/images/ic_arrows_right.png',width: 7,height: 12,),
                      ],
                    ),
                  ),
  ...
  Widget _buildGuideItemRow() {
    return Container(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Expanded( // 使用 Expanded 让图片占据剩余空间
            child: Image.asset(
              'assets/images/bg_home_banner.png',
              width: 233.w,
