        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '感谢您选择使用 TT钱包（以下简称“本软件”或“TT钱包”）。本《TT钱包用户服务与隐私政策》（以下简称“本协议”或“本政策”）由TT wallet Inc（以下简称“本公司”或“我们”）与使用 TT钱包服务的自然人或其他主体（以下简称“用户”或“您”）共同订立，对您使用 TT钱包相关服务的全过程具有法律约束力。',
                style: bodyStyle,
              ),
              SizedBox(height: 8.h),
              Text(
              ...
              Text(
                '1. 协议主体\n'
                '（1）本协议由您与TT wallet Inc订立。\n'
                '（2）TT wallet Inc依法运营并对 TT钱包软件及相关服务享有合法权利，但不对用户在区块链上的行为承担控制或干预能力。\n\n'
                '2. 适用范围\n'
              ...
              Text(
                ...
                '3. 因本协议引起的或与本协议有关的任何争议，双方应首先友好协商；协商不成的，任何一方均可向TT wallet Inc所在地有管辖权的人民法院提起诉讼。\n'
