...
class SelectContactsFromSearchOrganizationPage extends StatelessWidget {
  final logic = Get.find<SelectContactsFromSearchOrganizationLogic>();

  SelectContactsFromSearchOrganizationPage({super.key});
  ...
  Widget _buildDeptMemberItemView(MemberUser memberInfo) {
    Widget buildChild() => Ink(
          ...
          child: InkWell(
            onTap: logic.bridge.onTap(memberInfo),
            child: Container(
