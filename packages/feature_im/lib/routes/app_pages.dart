...
import '../pages/wallet/wallet_index_view.dart';
import '../pages/wallet/wallet_index_binding.dart';
import '../pages/wallet/wallet_create/wallet_create_view.dart';
import '../pages/wallet/wallet_create/wallet_create_binding.dart';
import '../pages/wallet/wallet_mnemonic/wallet_mnemonic_view.dart';
import '../pages/wallet/wallet_mnemonic/wallet_mnemonic_binding.dart';
import '../pages/wallet/wallet_mnemonic/wallet_mnemonic_backup/wallet_mnemonic_backup_view.dart';
import '../pages/wallet/wallet_mnemonic/wallet_mnemonic_backup/wallet_mnemonic_backup_binding.dart';
import '../pages/wallet/wallet_mnemonic/wallet_mnemonic_verify/wallet_mnemonic_verify_view.dart';
import '../pages/wallet/wallet_mnemonic/wallet_mnemonic_verify/wallet_mnemonic_verify_binding.dart';
import '../pages/wallet/wallet_mnemonic/wallet_mnemonic_success/wallet_mnemonic_success_view.dart';
import '../pages/wallet/wallet_mnemonic/wallet_mnemonic_success/wallet_mnemonic_success_binding.dart';
import '../pages/wallet/wallet_import/wallet_import_view.dart';
import '../pages/wallet/wallet_import/wallet_import_binding.dart';
import '../pages/wallet/wallet_register/wallet_register_view.dart';
import '../pages/wallet/wallet_register/wallet_register_binding.dart';
import '../pages/wallet/wallet_forget/wallet_forget_view.dart';
import '../pages/wallet/wallet_forget/wallet_forget_binding.dart';
...
class AppPages {
  ...
  static final routes = <GetPage>[
    ...
    _pageBuilder(
      ...
      page: () => WalletIndexView(),
      binding: WalletIndexBinding(),
    ),
    _pageBuilder(
    ...
    _pageBuilder(
      name: AppRoutes.walletMnemonic,
      page: () => WalletMnemonicView(),
      binding: WalletMnemonicBinding(),
    ),
    _pageBuilder(
      name: AppRoutes.walletMnemonicBackUp,
      page: () => WalletMnemonicBackupView(),
      binding: WalletMnemonicBackupBinding(),
    ),
    _pageBuilder(
      name: AppRoutes.walletMnemonicVerify,
      page: () => WalletMnemonicVerifyView(),
      binding: WalletMnemonicVerifyBinding(),
    ),
    _pageBuilder(
      name: AppRoutes.walletMnemonicSuccess,
      page: () => WalletMnemonicSuccessView(),
      binding: WalletMnemonicSuccessBinding(),
    ),
    _pageBuilder(
      name: AppRoutes.walletImport,
      page: () => WalletImportView(),
      binding: WalletImportBinding(),
    ),
    _pageBuilder(
      name: AppRoutes.walletRegister,
      page: () => WalletRegisterView(),
      binding: WalletRegisterBinding(),
    ),
    _pageBuilder(
      name: AppRoutes.walletForget,
      page: () => WalletForgetView(),
      binding: WalletForgetBinding(),
    ),
