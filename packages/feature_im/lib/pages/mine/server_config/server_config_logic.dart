...
class ServerConfigLogic extends GetxController {
  ...
  var logLevelCtrl = TextEditingController(text: 3.toString());
  ...
  void onInit() {
    ...
    logLevelCtrl.text = Config.logLevel.toString();
