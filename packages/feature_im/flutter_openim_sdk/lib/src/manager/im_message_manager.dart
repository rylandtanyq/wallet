...
class MessageManager {
  ...
  /// Create a hongbao message
  Future<Message> createHongbaoMessage({
    required String uuid,
    String? operationID,
  }) =>
      _channel
          .invokeMethod(
              'createHongbaoMessage',
              _buildParam({
                "uuid": uuid,
                "operationID": Utils.checkOperationID(operationID)
              }))
  ...
  Future<List<Message>> fetchSorroundMessages(
    FetchSurroundingMessagesReq req, {
    String? operationID,
  }) {
    return _channel
        .invokeMethod(
        ...
        .then((value) => Utils.toObj(
            value, (map) => AdvancedMessage.fromJson(map).messageList ?? []));
  }
