...
class Message {
  ...
  Message.fromJson(Map<String, dynamic> json) {
    ...
    typingElem = json['typingElem'] != null
        ...
        : null;
    dstUserIDs = json['dstUserIDs']?.cast<String>();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['dstUserIDs'] = this.dstUserIDs;
...
class HongbaoElem {
  ...
  HongbaoElem.fromJson(Map<String, dynamic> json) {
    uuid = json['uuid'];
...
class GroupMessageReceipt {
  ...
  GroupMessageReceipt.fromJson(Map<String, dynamic> json) {
    if (json['groupMessageReadInfo'] == null) {
      ...
      groupMessageReadInfo = (json['groupMessageReadInfo'] as List)
          .map((e) => GroupMessageReadInfo.fromJson(e))
          .toList();
    }
...
class GroupMessageReadInfo {
  ...
  GroupMessageReadInfo.fromJson(Map<String, dynamic> json) {
    if (json['readMembers'] == null) {
      ...
      readMembers = (json['readMembers'] as List)
...
class FetchSurroundingMessagesReq {
  final Message startMessage;
  final int before;
  final int after;
  final FetchSurroundingHistoryViewType viewType;

  FetchSurroundingMessagesReq({
    required this.startMessage,
    required this.before,
    required this.after,
    this.viewType = FetchSurroundingHistoryViewType.search,
  });

  Map<String, dynamic> toJson() {
    return {
      'startMessage': startMessage.toJson(),
      'before': before,
      'after': after,
  ...
  FetchSurroundingMessagesReq.fromJson(Map<String, dynamic> json)
      : startMessage = Message.fromJson(json['startMessage']),
        before = json['before'],
        after = json['after'],
        viewType = FetchSurroundingHistoryViewType.values[json['viewType']];
}
