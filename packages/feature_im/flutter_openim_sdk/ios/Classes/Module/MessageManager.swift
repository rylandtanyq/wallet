...
public class MessageManager: BaseServiceManager {
    ...
    public override func registerHandlers() {
        ...
        self["getGroupMessageReaderList"] = getGroupMessageReaderList
        self["sendGroupMessageReadReceipt"] = sendGroupMessageReadReceipt
    }
    ...
    func fetchSurroundingMessages(methodCall: FlutterMethodCall, result: @escaping FlutterResult){
        Open_im_sdkFetchSurroundingMessages(BaseCallback(result: result), methodCall[string: "operationID"], methodCall.toJsonString())
    }
    ...
    func getGroupMessageReaderList(methodCall: FlutterMethodCall, result: @escaping FlutterResult){
        Open_im_sdkGetGroupMessageReaderList(BaseCallback(result: result), methodCall[string: "operationID"], methodCall[string: "conversationID"],
         methodCall[string: "clientMsgID"], methodCall[int32: "filter"], methodCall[int32: "offset"], methodCall[int32: "count"])
    }

    func sendGroupMessageReadReceipt(methodCall: FlutterMethodCall, result: @escaping FlutterResult){
        Open_im_sdkSendGroupMessageReadReceipt(BaseCallback(result: result), methodCall[string: "operationID"], methodCall[string: "conversationID"], methodCall[jsonString: "clientMsgIDs"])
    }
