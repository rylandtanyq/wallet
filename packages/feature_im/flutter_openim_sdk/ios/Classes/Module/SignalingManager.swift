...
public class SignalingManager: BaseServiceManager {
    ...
    public override func registerHandlers() {
        ...
        self["getSignalingInvitationInfoStartApp"] = getSignalingInvitationInfoStartApp
    }
    ...
    func getSignalingInvitationInfoStartApp(methodCall: FlutterMethodCall, result: @escaping FlutterResult){
         Open_im_sdkGetSignalingInvitationInfoStartApp(BaseCallback(result: result), methodCall[string: "operationID"])
    }
}
