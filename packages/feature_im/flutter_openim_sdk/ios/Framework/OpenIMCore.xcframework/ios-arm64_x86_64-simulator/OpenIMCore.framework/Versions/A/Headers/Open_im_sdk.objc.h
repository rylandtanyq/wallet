...
- (id<Open_im_sdk_callbackOnListenerForService> _Nullable)forServiceListener;
...
- (void)setForServiceListener:(id<Open_im_sdk_callbackOnListenerForService> _Nullable)forServiceListener;
...
FOUNDATION_EXPORT void Open_im_sdkFetchSurroundingMessages(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, NSString* _Nullable req);
...
FOUNDATION_EXPORT void Open_im_sdkGetGroupMessageReaderList(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, NSString* _Nullable conversationID, NSString* _Nullable clientMsgID, int32_t filter, int32_t offset, int32_t count);
...
FOUNDATION_EXPORT void Open_im_sdkGetSignalingInvitationInfoStartApp(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID);
...
FOUNDATION_EXPORT void Open_im_sdkSendGroupMessageReadReceipt(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, NSString* _Nullable conversationID, NSString* _Nullable clientMsgIDs);
...
FOUNDATION_EXPORT void Open_im_sdkSetForServiceListener(id<Open_im_sdk_callbackOnListenerForService> _Nullable listener);
...
FOUNDATION_EXPORT void Open_im_sdkSignalingGetTokenByRoomID(id<Open_im_sdk_callbackBase> _Nullable callback, NSString* _Nullable operationID, NSString* _Nullable roomID);
