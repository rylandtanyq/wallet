...
class MeetingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VisibilityDetector(
      onVisibilityChanged: (value) {
        if (!value.visibleBounds.isEmpty) {
          logic.queryUnfinishedMeeting();
        }
      },
      key: logic.globalKey,
      child: Scaffold(
  ...
  Widget _buildMeetingInfoItemView(MeetingInfoSetting meetingInfo) => GestureDetector(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: logic.isStartedMeeting(meetingInfo) ? Styles.c_FFB300 : Styles.c_0089FF,
                          ...
                          child: (logic.isStartedMeeting(meetingInfo) ? StrRes.started : StrRes.didNotStart).toText..style = Styles.ts_FFFFFF_10sp,
                        ),
                      ],
                    ),
                    4.verticalSpace,
                    ...
                    logic.getMeetingOrganizer(meetingInfo).toText..style = Styles.ts_8E9AB0_13sp,
                  ],
                ),
              ),
