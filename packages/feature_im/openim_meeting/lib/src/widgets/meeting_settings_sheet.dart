...
/*
  _meetingInfoChanged(MeetingInfo meetingInfo) {
    if (!mounted) return;
    setState(() {
      _allowParticipantUnmute = meetingInfo.participantCanUnmuteSelf!;
      _allowParticipantVideo = meetingInfo.participantCanEnableVideo!;
      _onlyHostCanInvite = meetingInfo.onlyHostInviteUser!;
      _onlyHostCanShareScreen = meetingInfo.onlyHostShareScreen!;
      _joinMeetingDefaultMute = meetingInfo.joinDisableMicrophone!;
    });
  }
 ...
 */
  ...
  _confirm() => widget.controller?.reverse().then((value) => widget.onConfirm?.call(<String, dynamic>{
        'participantCanUnmuteSelf': _allowParticipantUnmute,
        'participantCanEnableVideo': _allowParticipantVideo,
        'onlyHostShareScreen': _onlyHostCanShareScreen,
        'onlyHostInviteUser': _onlyHostCanInvite,
        'joinDisableMicrophone': _joinMeetingDefaultMute,
      }));
