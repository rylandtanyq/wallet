...
abstract class MeetingView extends StatefulWidget {
  ...
  final Room room;
  final MeetingInfoSetting? infoSetting;
...
abstract class MeetingViewState<T extends MeetingView> extends State<T> {
  ...
  bool get joinDisabledMicrophone => meetingInfo == null
      ? widget.infoSetting?.setting.disableMicrophoneOnJoin == true
      : meetingInfo?.setting.disableMicrophoneOnJoin == true;

  bool get joinDisabledVideo => meetingInfo == null
      ? widget.infoSetting?.setting.disableCameraOnJoin == true
      : meetingInfo?.setting.disableCameraOnJoin == true;

  String? get hostUserID => meetingInfo == null ? widget.infoSetting?.hostUserID : meetingInfo?.hostUserID;
