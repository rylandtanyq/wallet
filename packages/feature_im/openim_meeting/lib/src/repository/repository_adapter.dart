...
abstract class IMeetingRepository {
  ...
  Future<bool> endMeeting(String meetingID, String userID, {MeetingEndType endType = MeetingEndType.EndType}) {
    throw UnimplementedError();
  }
  ...
  Future<bool> modifyParticipantName(
      {required String meetingID, required String userID, required String participantUserID, required String nickname}) {
    throw UnimplementedError();
  }

  Future<bool> kickParticipant({required String meetingID, required String userID, required List<String> participantUserIDs}) {
    throw UnimplementedError();
  }

  Future<bool> setMeetingHost({required String meetingID, required String userID, required String hostUserID, required List<String> coHostUserIDs}) {
    throw UnimplementedError();
  }
}
