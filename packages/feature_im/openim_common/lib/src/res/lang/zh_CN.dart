const Map<String, String> zh_CN = {
  ...
  "plsEnterEmail": "请输入用户名",
  "password": "密码",
  "plsEnterPassword": "请输入您的密码",
  "account": "钱包地址",
  "plsEnterAccount": "请输入钱包地址",
  "forgetPassword": "忘记密码",
  ...
  'plsEnterRightAccount': '请输入正确的用户名',
  ...
  'callFail': '你无法呼叫该用户',
  'search_by_phone_and_uid': '通过用户名/钱包地址/ID号搜索添加',
  ...
  'wallet':'注册',
  'walletCreate':'创建钱包',
  'walletMnemonicCreate':'生成助记词',
  'walletMnemonicBackUp':'备份助记词',
  'walletMnemonicVerify':'验证助记词',
  'walletImport':'导入钱包',
  'walletForget':'忘记密码',
  'walletMnemonicCreateTitle':'备份助记词，保护钱包安全',
  'walletMnemonicCreateSubTitle':'助记词是恢复钱包的凭证，并且仅存在于您的设备中，请务必做好备份',
  'walletMnemonicCreateTips':'重要提醒',
  'walletMnemonicCreateTips1':'助记词拥有恢复钱包及重置密码，建议纸笔手写方式准确无误抄写助记词，并存放在安全的地方',
  'walletMnemonicCreateError':'生成失败',
  'walletMnemonicBackUpTitle':'请按顺序抄写您的助记词',
  'walletMnemonicBackUpSubTitle':'请勿截屏或网络存储和传输，以免造成泄露',
  'walletMnemonicBackUpBtn1':'验证备份',
  'walletMnemonicBackUpBtn2':'复制助记词',
  'walletMnemonicVerifyTitle':'请按顺序抄写您的助记词',
  'walletMnemonicVerifySubTitle':'点击单词，按照正确顺序放在一起，以便验证您备份助记词 是否正确',
  'walletMnemonicVerifyBtn':'完成',
  'walletMnemonicVerifySuccess':'完成',
  'walletImportMnemonicPlace':'请输入助记词，用空格分隔',
  'walletImportMnemonicError':'请输入助记词',
  'walletImportPaste':'粘贴',
  'walletImportUserNamePlace':'请输入用户名',
  'walletImportPassPlace':'请输入密码，不少于8位数',
  'walletImportPassConfigm':'请确认密码',
  'walletImportAgree':'我已阅读并同意',
  'walletImportPrivacy':'《用户协议》',
  'walletImportPrivacyError':'请阅读并同意用户协议',
  'walletImportError':'助记词导入失败',
  'walletForgetMnemonicPlace':'请输入助记词，用空格分隔',
  'walletForgetMnemonicError':'请输入助记词',
  'walletForgetPaste':'粘贴',
  'walletForgetPass':'设置新密码',
  'walletForgetPassPlace':'请输入密码，不少于8位数',
  'walletForgetPassConfig':'确认新密码',
  'walletForgetPassConfigPlace':'请确认密码',
  'walletForgetError':'助记词导入失败',
  'walletRegisterAddress':'请输入钱包地址',
  'walletRegisterUserName':'请输入用户名',
  'walletRegisterPass':'请输入密码，不少于8位数',
  'walletRegisterPassConfirm':'请确认密码',
  'walletRegisterAgree':'我已阅读并同意',
  'walletRegisterPrivacy':'《用户协议》',
  'walletRegisterPrivacyError':'请阅读并同意用户协议',
  ...errorMessages,
};
