const Map<String, String> en_US = {
  "welcome": "Welcome to 康语",
  "userID": "user id",
  "phoneNumber": "Phone Number",
  "plsEnterPhoneNumber": "Please enter your phone number",
  "plsEnterEmail": "Please enter your username",
  "password": "Password",
  "plsEnterPassword": "Please enter your password",
  "account": "WalletAddress",
  "plsEnterAccount": "Please enter your wallet address",
  ...
  "createGroupHint": "Create a group, fully utilize 康语",
  "addGroup": "Add Group",
  ...
  'oldAndNewPwdSame': 'The original password and new password are the same',
  ...
  'search_by_phone_and_uid': 'search by address or username or uid',
  ...
  'endMeetingFailure': 'Failed to end the meeting',
  ...
  'walletMnemonicCreate': 'Generate Mnemonic Phrase',
  'walletMnemonicBackUp': 'Back Up Mnemonic Phrase',
  'walletMnemonicVerify': 'Verify Mnemonic Phrase',
  'walletImport': 'Import Wallet',
  'walletForget': 'Forgot Password',
  'walletMnemonicCreateTitle': 'Back Up Mnemonic Phrase to Secure Your Wallet',
  'walletMnemonicCreateSubTitle': 'Mnemonic phrase is the credential to recover your wallet and is only stored on your device. Please make sure to back it up properly.',
  'walletMnemonicCreateTips': 'Important Reminder',
  'walletMnemonicCreateTips1': 'Mnemonic phrase can be used to recover your wallet and reset your password. It is recommended to write down the mnemonic phrase accurately by hand with pen and paper and store it in a safe place.',
  'walletMnemonicCreateError': 'Generation Failed',
  'walletMnemonicBackUpTitle': 'Please Copy Your Mnemonic Phrase in Order',
  'walletMnemonicBackUpSubTitle': 'Do not take screenshots, store or transmit it online to avoid leakage.',
  'walletMnemonicBackUpBtn1': 'Verify Backup',
  'walletMnemonicBackUpBtn2': 'Copy Mnemonic Phrase',
  'walletMnemonicVerifyTitle': 'Please Arrange Your Mnemonic Phrase in Order',
  'walletMnemonicVerifySubTitle': 'Click the words and arrange them in the correct order to verify if your backed-up mnemonic phrase is correct.',
  'walletMnemonicVerifyBtn': 'Complete',
  'walletMnemonicVerifySuccess': 'Completed',
  'walletImportMnemonicPlace': 'Please enter mnemonic phrase, separated by spaces',
  'walletImportMnemonicError': 'Please enter mnemonic phrase',
  'walletImportPaste': 'Paste',
  'walletImportUserNamePlace': 'Please enter username',
  'walletImportPassPlace': 'Please enter password (at least 8 characters)',
  'walletImportPassConfigm': 'Please confirm password',
  'walletImportAgree': 'I have read and agree to the',
  'walletImportPrivacy': 'User Agreement',
  'walletImportPrivacyError': 'Please read and agree to the User Agreement',
  'walletImportError': 'Mnemonic Phrase Import Failed',
  'walletForgetMnemonicPlace': 'Please enter mnemonic phrase, separated by spaces',
  'walletForgetMnemonicError': 'Please enter mnemonic phrase',
  'walletForgetPaste': 'Paste',
  'walletForgetPass': 'Set New Password',
  'walletForgetPassPlace': 'Please enter password (at least 8 characters)',
  'walletForgetPassConfig': 'Confirm New Password',
  'walletForgetPassConfigPlace': 'Please confirm password',
  'walletForgetError': 'Mnemonic Phrase Verification Failed',
  'walletRegisterAddress': 'Please enter wallet address',
  'walletRegisterUserName': 'Please enter username',
  'walletRegisterPass': 'Please enter password (at least 8 characters)',
  'walletRegisterPassConfirm': 'Please confirm password',
  'walletRegisterAgree': 'I have read and agree to the',
  'walletRegisterPrivacy': 'User Agreement',
  'walletRegisterPrivacyError': 'Please read and agree to the User Agreement',
  ...errorMessages,
};
...
const Map<String, String> errorMessages = {
  ...
  '20015': 'Your balance is insufficient',
