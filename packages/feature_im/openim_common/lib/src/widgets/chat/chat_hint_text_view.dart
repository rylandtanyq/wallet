        ...
        case MessageType.memberInvitedNotification:
          {
            ...
            if (ntf.inviterUser != null) {
              aMap[ntf.inviterUser!.userID!] = IMUtils.getGroupMemberShowName(ntf.inviterUser!);
              infoMap[ntf.inviterUser!.userID!] = ntf.inviterUser!;
            } else {
            ...
            final a = ntf.inviterUser?.userID ?? ntf.opUser!.userID!;
