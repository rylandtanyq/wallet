...
class ChatItemContainer extends StatelessWidget {
  ...
  Widget _buildLevelView() {
    if (userRole != null) {
      if (userRole == 100 || userRole == 60) {
        return Container(
          padding: EdgeInsets.fromLTRB(5, 2, 5, 2),
          decoration: BoxDecoration(
              color: Color(0xFFfb921f), borderRadius: BorderRadius.circular(5)),
          child: Row(
            children: [
              if (userLevel != null)
                Text(
                  userLevel?["levels"].length > 0
                      ? userLevel!["levels"][0]["name"]
                      : "",
      ...
      if (userLevel != null) {
        return Container(
          padding: EdgeInsets.fromLTRB(5, 2, 5, 2),
          decoration: BoxDecoration(
              color: Color(0xFFf59795), borderRadius: BorderRadius.circular(5)),
          child: Center(
            child: Text(
              userLevel?["levels"].length > 0
                  ? userLevel!["levels"][0]["name"]
