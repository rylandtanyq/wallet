...
class _CustomMKMaterialVideoControls extends StatefulWidget {
  ...
  @override
  State<_CustomMKMaterialVideoControls> createState() =>
      _CustomMMaterialVideoControlsState();
}

class _CustomMMaterialVideoControlsState
    extends State<_CustomMKMaterialVideoControls> {
  @override
