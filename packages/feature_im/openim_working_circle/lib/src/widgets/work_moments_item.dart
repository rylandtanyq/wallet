...
class WorkMomentsItem extends StatelessWidget {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                if (moments.atUsers?.isNotEmpty == true && _showDelIcon)
                  _buildMentionedView(),
                Stack(
  ...
  Widget _buildMentionedView() {
    Logger.print(
        'atUsers: count:${moments.atUsers!.length} ${moments.atUsers?.map((e) => IMUtils.getShowName(e.userID, e.nickname)).join('、')}');
          ...
          children: [
            ...
            ...likeUsers
                .map((e) => TextSpan(
                      ...
                      children: [
                        if (likeUsers.last != e)
                          TextSpan(text: '、', style: Styles.ts_0C1C33_12sp),
                      ],
                    ))
                .toList(),
          ],
  ...
  Widget _buildMetaView(int type, List<Metas> metas) {
    return GridView.builder(
      ...
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: (type == 1 || metas.length == 1) ? 2 : 3,
        childAspectRatio: (type == 1 || metas.length == 1) ? 9 / 16 : 1.0,
