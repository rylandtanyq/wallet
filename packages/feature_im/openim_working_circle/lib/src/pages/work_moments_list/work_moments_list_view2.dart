...
import 'package:openim_working_circle/src/pages/work_moments_list/work_moments_list_logic2.dart';
...
class WorkMomentsListPage2 extends StatelessWidget {
  // final WorkMomentsListLogic logic = Get.find(tag: GetTags.moments);
  final WorkMomentsListLogic2 logic = Get.put(WorkMomentsListLogic2());
  WorkMomentsListPage2({super.key});
  ...
  Widget get _popButton => PopButton(
        popCtrl: logic.popCtrl,
        menus: [
          PopMenuInfo(
            text: StrRes.publishPicture,
            iconWidget: Icon(
              Icons.image,
  ...
  //
  // Widget get _popButton => Theme(
  //     data: Theme.of(Get.context!).copyWith(cardColor: Colors.red, canvasColor: Colors.red),
