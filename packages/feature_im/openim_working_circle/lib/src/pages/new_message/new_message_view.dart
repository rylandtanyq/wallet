                ...
                info.type == 1
                    ? Row(
                        children: [
                          ...
                          4.horizontalSpace,
                          sprintf(StrRes.likedWho, [info.nickname]).toText
                            ..style = Styles.ts_0C1C33_14sp,
                        ],
                      )
                    // 提到了你
                    : info.type == 2
                        ? (sprintf(StrRes.mentionedWho,
                            [info.atUsers?.firstOrNull?.nickname]).toText
                          ..style = Styles.ts_0C1C33_14sp)
                        // 评论了你
                        : (null == replyNickname || replyNickname.isEmpty)
                            ? (sprintf(StrRes.commentedWho,
                                [info.nickname, content]).toText
                              ..style = Styles.ts_0C1C33_14sp)
                            // 某某回复了某某
                            : RichText(
