      ...
      appBar: AppBar(
        ...
        title: Theme(
          ...
          child: TabBar(
            ...
            tabs: [
              Tab(child: Text(t.wallet.addressBook, maxLines: 1, overflow: TextOverflow.ellipsis)),
              Tab(child: Text(t.wallet.myWallet, maxLines: 1, overflow: TextOverflow.ellipsis)),
            ],
          ),
        ),
        centerTitle: true,
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(t.wallet.tipFillAddress, style: AppTextStyles.size13.copyWith(color: Theme.of(context).colorScheme.onBackground)),
            ],
          ),
        ),
        Container(
          ...
          child: Text(t.wallet.addNewAddress, style: AppTextStyles.headline4.copyWith(color: Theme.of(context).colorScheme.onPrimary)),
        ),
      ],
    ),
  );
