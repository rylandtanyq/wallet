import 'package:feature_wallet/src/payee_select_network_dialog.dart';
...
class _SelectedPayeePageState extends State<SelectedPayeePage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final List<String> categories = [t.wallet.byCoin, t.wallet.byNetwork];

    return Scaffold(
      appBar: CustomAppBar(title: t.wallet.receive, centerTitle: false),
      body: Container(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 8.w),
                    Text(t.wallet.tokenNameOrContract, style: AppTextStyles.labelMedium.copyWith(color: Theme.of(context).colorScheme.onSurface)),
                  ],
                ),
              ),
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(t.wallet.multiChain, style: AppTextStyles.size13.copyWith(color: Theme.of(context).colorScheme.onSurface)),
                ],
              ),
            ),
            Column(
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Icon(Icons.search, color: Theme.of(context).colorScheme.onBackground),
              SizedBox(width: 8.w),
              Text(t.wallet.networkName, style: AppTextStyles.labelMedium.copyWith(color: Theme.of(context).colorScheme.onSurface)),
            ],
          ),
        ),
        Expanded(
