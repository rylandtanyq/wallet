    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Text(t.wallet.trade_history, style: AppTextStyles.headline4.copyWith(color: Theme.of(context).colorScheme.onBackground)),
        ),
      ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(t.wallet.no_transfer_records_yet, style: AppTextStyles.bodyMedium.copyWith(color: Theme.of(context).colorScheme.onSurfaceVariant)),
        ],
      ),
    );
  }
                ...
                child: Row(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Text(
                          item.to == _currentSelectedAddress ? t.wallet.receive : t.transfer_receive_payment.transfer,
