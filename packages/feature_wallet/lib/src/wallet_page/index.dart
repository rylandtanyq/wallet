...
import 'package:feature_wallet/src/wallet_page/service/wallet_page_provide.dart';
import 'package:feature_wallet/src/wallet_page_select_wallet_dialog.dart';
...
import 'package:feature_wallet/src/wallet_page/fragments/wallet_page_bankcard_fragments.dart';
import 'package:feature_wallet/src/wallet_page/fragments/wallet_page_build_top_frafments.dart';
import 'package:feature_wallet/src/wallet_page/fragments/wallet_page_defi_fragments.dart';
import 'package:feature_wallet/src/wallet_page/fragments/wallet_page_nft_fragment.dart';
import 'package:feature_wallet/src/wallet_page/fragments/wallet_page_screen_loader_fragments.dart';
import 'package:feature_wallet/src/wallet_page/fragments/wallet_page_token_fragments.dart';
import 'package:feature_wallet/src/wallet_page/models/token_price_model.dart';
import 'package:feature_wallet/src/wallet_page/utils/kBuiltInSolanaTokens.dart';
...
import 'package:shared_ui/dialog/full_screen_state_dialog.dart';
...
class _WalletPageState extends ConsumerState<WalletPage>
    ...
    _priceSub = ref.listenManual<AsyncValue<TokenPriceModel>>(getWalletTokensPriceProvide(_addresses), (prev, next) {
      next.when(
        data: (data) async {
          ...
          final nowAddr = (await HiveStorage().getValue<String>('selected_address', boxName: boxWallet) ?? '').trim().toLowerCase();
          if (nowAddr != reqAddr) return;

          // 回写 Hive + 刷新 UI
          final toSave = _tokenList.map((t) => t.toJson()).toList();
          await HiveStorage().putList<Map>(key, toSave, boxName: boxTokens);
  ...
  String _getCommonName(String key) {
    switch (key) {
      case 'allNetworks':
        return t.wallet.allNetworks;
      case 'Solana':
        return t.wallet.Solana;
      case 'BNB':
        return t.wallet.BNB;
      case 'Bitcoin':
        return t.wallet.Bitcoin;
      case 'Base':
        return t.wallet.Base;
      case 'Ethereum':
        return t.wallet.Ethereum;
      case 'Polygon':
        return t.wallet.Polygon;
      case 'Arbitrum':
        return t.wallet.Arbitrum;
      case 'Sui':
        return t.wallet.Sui;
      default:
        return key;
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> items = [
      ...
      {"id": "Solana", "path": "assets/images/solana_logo.png", "netName": t.wallet.Solana},
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: t.wallet.searchNetwork,
